...
***Tipp***
 ...
 rename yt2mp3.py to yt2mp3.command, then open your terminal and make the file 
 executable by setting admin rights to it: cd to Desktop and type: chmod +x yt2mp3.command
